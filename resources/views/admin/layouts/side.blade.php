    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu  mb-4">
            ...
            <li class="nav-item {{ Route::is('index.mahasiswa') ? 'active' : ''}}">
                <a href="{{ route('index.mahasiswa') }} " class="nav-link "><i class="fas fa-user"></i><span>Mahasiswa</span></a>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a class="nav-link beep beep-sidebar" href="components-empty-state.html">Empty State</a>
                    </li>
                    <li>
